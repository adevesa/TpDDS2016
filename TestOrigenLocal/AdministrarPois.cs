...
namespace TestOrigenLocal
{
    ...
    public class AdministrarPois
    {
        ...
        {
            ParadaDeColectivo parada7Virreyes = new ParadaDeColectivo(10, "parada 7 virreyes", new Coordenada(-34.64277, -58.4614451));
        ...
        {
            //Objeto inicial//
            LocalComercial brooklynBar  = new LocalComercial(13, "brooklyn bar", "costa Rica 4588", new Coordenada(-34.5889131, -58.4260504));
